...
const imageBasePath = "/src/assets/images/SWManual/"
      ...
      <ContentSection
        ...
        content={
          <>
            ...
            <img src={imageBasePath + "image2.png"} alt='Fly Rig Video Control Logo'></img>
          </>
        }
      />
      ...
      <ContentSection
        ...
        content={
            <ol>
              ...
              <img src={imageBasePath + "image3.png"} alt='Fly Rig Video Control Logo'></img>
      ...
      <ContentSection
        ...
        content={
          <ol>
            ...
            <img src={imageBasePath + "image4.png"} alt='Fly Rig Video Control Logo'></img>
            <li>
      ...
      <ContentSection
        ...
        content={
          <ol>
            ...
            <img src={imageBasePath + "image5.png"} alt='Fly Rig Video Control Logo'></img>
        ...
        content={
          <>
            ...
            <ul>
              ...
              <img src={imageBasePath + "image6.png"} style={{ backgroundColor: "white" }} alt='Fly Rig Video Control Logo'></img>
              <img src={imageBasePath + "image7.png"} alt='Fly Rig Video Control Logo'></img>
            </ul>
          </>
        }
      />
      ...
      <ContentSection
        ...
        content={
          <>
            ...
            <ol>
              <img src={imageBasePath + "image8.png"} style={{width: "350px", wordWrap: "break-word" }} alt='Fly Rig Video Control Logo'></img>
